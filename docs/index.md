...
Для назначения роли сотруднику должна быть назначена должность.

Назначить сотруднику роль означает: присвоить сотруднику в рамках занимаемой в организации должности определённый тип роли.
...
| ---------------------- | ------ | -------------- | -------- |
| `person`               | [Guid](#guid) | Да | Идентификатор сотрудника |
| `organization`         | [Guid](#guid) | Да | Идентификатор организации, в которой выделяется роль |
| `positionOrganization` | [Guid](#guid) | Да | Идентификатор должности в организации |
